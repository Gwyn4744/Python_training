...
# type: str
a = f"Euler's number with 0 decimal places: {math.ceil(EULER)}"

#  Euler's number with 1 decimal places
# type: str
b = f"Euler's number with 1 decimal places: {round(EULER,1)}"

#  Euler's number with 2 decimal places
# type: str
c = f"Euler's number with 2 decimal places: {round(EULER,2)}"

#  Euler's number with 3 decimal places
# type: str
d = f"Euler's number with 3 decimal places: {round(EULER,3)}"
